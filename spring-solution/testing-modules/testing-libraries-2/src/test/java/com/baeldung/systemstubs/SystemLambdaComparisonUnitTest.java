...
class SystemLambdaComparisonUnitTest {
    ...
    private EnvironmentVariables environmentVariables =
      new EnvironmentVariables("ADDRESS", "https://www.example.com");
    ...
    void multipleSystemLambdas() throws Exception {
        restoreSystemProperties(() -> {
            withEnvironmentVariable("URL", "https://www.example.com")
                .execute(() -> {
                    System.setProperty("log_dir", "test/resources");
                    assertEquals("test/resources", System.getProperty("log_dir"));
                    assertEquals("https://www.example.com", System.getenv("URL"));
                });
        });
    }
    ...
    void multipleSystemStubs() {
        System.setProperty("log_dir", "test/resources");
        assertEquals("test/resources", System.getProperty("log_dir"));
        assertEquals("https://www.example.com", System.getenv("ADDRESS"));
    }
}
