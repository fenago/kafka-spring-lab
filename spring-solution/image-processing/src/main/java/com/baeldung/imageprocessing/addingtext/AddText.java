...
public class AddText {
    public static void main(String[] args) throws IOException {
        ...
        ImagePlus resultPlus= signImageImageProcessor("www.example.com", imagePath);
        resultPlus.show();
        
        ImagePlus resultGraphics = new ImagePlus("", signImageGraphics("www.example.com", imagePath));
        resultGraphics.show();

        ImagePlus resultGraphicsWithIterator = new ImagePlus("", signImageGraphicsWithIterator("www.example.com", imagePath));
        resultGraphicsWithIterator.show();

        ImagePlus resultGraphicsCentered = new ImagePlus("", signImageCenter("www.example.com", imagePath));
        resultGraphicsCentered.show();

        ImagePlus resultGraphicsBottomRight = new ImagePlus("", signImageBottomRight("www.example.com", imagePath));
        resultGraphicsBottomRight.show();

        ImagePlus resultGraphicsTopLeft= new ImagePlus("", signImageTopLeft("www.example.com", imagePath));
        resultGraphicsTopLeft.show();

        ImagePlus resultGraphicsAdaptBasedOnImage= new ImagePlus("", signImageAdaptBasedOnImage("www.example.com", imagePath));
